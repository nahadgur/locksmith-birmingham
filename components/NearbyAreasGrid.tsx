...
export function NearbyAreasGrid({ cityName, serviceSlug, serviceName, initialVisible = 10 }: NearbyAreasGridProps) {
  ...
  const description = serviceName
    ...
    : `Our installers in ${cityName} serve homeowners from across the surrounding area. If you live in any of the towns, villages, or nearby areas listed below, you are within reach of expert installation services. Get matched with a local installer today.`;
  ...
  return (
    <section className="mb-16">
      ...
      <div className="mt-6 prose prose-sm max-w-none text-gray-500">
        <p>
          Homeowners from {areas.slice(0, 5).join(', ')}, and other areas around {cityName} regularly use our service to find installers.{' '}
          {serviceName
