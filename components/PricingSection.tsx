    ...
    <section className="mb-16">
      ...
      {cityName && (
        <div className="mt-8 prose prose-sm max-w-none text-gray-600">
          <p>
            The cost of installation in {cityName} depends on several factors: the material, specification, and any bespoke design requirements. Prices vary across depending on site conditions and specification, but the installers in our {cityName} network are competitively priced for the quality of work they deliver. Every installer offers a free site survey so you can get an accurate, itemised quote before making any commitment.
          </p>
        </div>
      )}
    </section>
