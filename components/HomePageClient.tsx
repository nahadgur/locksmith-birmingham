  ...
  return (
    <>
      ...
      <main className="flex-grow">
        ...
        {/* Guides - Query Network Links */}
        <section className="section-padding bg-white">
          <div className="container-width">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">Locksmith Guides for Birmingham Homeowners</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">Expert advice on locks, security standards, and protecting your Birmingham property.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {guides.slice(0, 6).map(guide => (
                <Link key={guide.slug} href={`/guides/${guide.slug}/`} className="group flex items-start gap-3 p-5 bg-gray-50 rounded-xl border border-gray-100 hover:border-brand-300 hover:bg-brand-50 transition-all">
